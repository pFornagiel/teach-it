  ...
  const handleFiles = async (files: FileList | File[]) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          // Pass the list of filenames to the next page
    ...
    <Layout>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="max-w-xl mx-auto w-full">
          <Card
            className="border-4 border-black shadow-neo-lg bg-white overflow-hidden p-8 md:p-10 hover:scale-[1.01] transition-transform duration-300"
          >
            <div
              className={`
